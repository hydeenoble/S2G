$(document).ready(function () {
    ...
    if ((urlParameters.to - urlParameters.from) <= 150) {
        $('.credit-canvas').addClass('col-lg-6');
        $('.debit-canvas').addClass('col-lg-6');
    }

    $.ajax({
        url: basrurl + "json_data.php?from=" + urlParameters.from + "&to=" + urlParameters.to,
        type: "GET",
